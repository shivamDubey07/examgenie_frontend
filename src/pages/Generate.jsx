...
export default function Generate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Generating exam:', form)
      setTimeout(() => navigate('/exam/1'), 2000)
    } catch (err) {
      console.error(err)
    } finally {
      setLoading(false)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 text-white">
      ...
      <nav className="flex justify-between items-center px-10 py-5 border-b border-white/10">
        <h1 onClick={() => navigate('/dashboard')} className="text-2xl font-bold cursor-pointer">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-blue-200">Fill in the details and AI will create your exam instantly</p>
        </div>

        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur rounded-2xl p-8 flex flex-col gap-5">

          {/* Exam Name */}
          <div>
            <label className="text-blue-200 text-sm mb-1 block">Exam Name</label>
            <input
              name="name"
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-blue-200 text-sm mb-1 block">Difficulty</label>
              <select
                name="difficulty"
            ...
            <div>
              <label className="text-blue-200 text-sm mb-1 block">Number of Questions</label>
              <select
                name="num_questions"
